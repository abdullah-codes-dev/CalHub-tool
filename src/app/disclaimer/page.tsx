...
export default function DisclaimerPage() {
  return (
    <>
      <Head>
        <title>Disclaimer - JazzCasher</title>
        <meta
          name="description"
          content="Read the official disclaimer of JazzCasher. Learn about limitations of our financial, health, education, and revenue calculators before use."
        />
        <link rel="canonical" href="https://www.jazzcasher.site/disclaimer" />
      </Head>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Important information about using our calculator tools
            </p>
          </div>
              ...
              <div className="prose max-w-none space-y-6">
                <section>
                  ...
                  <p className="text-gray-600">
                    The information and calculations provided by JazzCasher are for educational and informational
                    purposes only. While we strive for accuracy, we make no representations or warranties of any kind,
                ...
                <section>
                  ...
                  <p className="text-gray-600">
                    Health-related calculators (BMI, calorie calculators) provide general estimates and should not
                ...
                <section>
                  ...
                  <p className="text-gray-600">
                    In no event will JazzCasher be liable for any loss or damage including without limitation, indirect
                    or consequential loss or damage, or any loss or damage whatsoever arising from loss of data or
                    profits arising out of, or in connection with, the use of this website or its calculators.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-gray-600">
                    While we make every effort to ensure our calculators are accurate and up-to-date, formulas, rates,
                    and standards may change over time. We recommend verifying important calculations with current
                    official sources or professional advisors.
                  </p>
                </section>
