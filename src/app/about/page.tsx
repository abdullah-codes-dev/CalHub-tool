...
export default function AboutPage() {
	...
	return (
		<>
			<Head>
				<title>About JazzCasher - Accurate & Free Online Calculators</title>
				<meta
					name="description"
					content="Learn more about JazzCasher. We provide 100% free, accurate, and privacy-focused calculators for EMI, BMI, GPA, AdSense revenue, and more."
				/>
				<link rel="canonical" href="https://www.jazzcasher.site/about" />
			</Head>
