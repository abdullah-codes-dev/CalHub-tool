						...
						<CardContent>
							<div className='prose max-w-none'>
								<p className='text-gray-600 mb-4'>
									AdSense revenue depends on several factors.
									...
									<div>
										...
										<ul className='list-disc list-inside space-y-1 text-gray-600'>
											...
											<li>
												...
												insurance, and tech have higher
												CPCs
											</li>
											<li>
												<strong>Geography:</strong>{" "}
												Traffic from developed countries
												earns more
											</li>
											<li>
												<strong>Ad Placement:</strong>{" "}
												Above-the-fold ads perform
												better
											</li>
											<li>
								...
								<p className='text-sm text-gray-500 mt-4'>
									<strong>Disclaimer:</strong> These are
									estimates only. Actual earnings may vary
									significantly based on numerous factors
									including content quality, audience
