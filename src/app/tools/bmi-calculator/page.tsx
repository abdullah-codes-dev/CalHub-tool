	...
	return (
		<>
			...
			<Head>
				...
				<meta
					name="description"
					content="Free online BMI Calculator to check your Body Mass Index and health category instantly using metric or imperial units."
				/>
				<meta name="robots" content="index, follow" />
				<link
					rel="canonical"
					href="https://www.jazzcasher.site/tools/bmi-calculator"
				/>
				<script
					...
					dangerouslySetInnerHTML={{
						__html: JSON.stringify({
							...
							"@type": "WebApplication",
							name: "BMI Calculator",
							url: "https://www.jazzcasher.site/tools/bmi-calculator",
							applicationCategory: "HealthApplication",
							operatingSystem: "All",
							description:
								"Free online BMI Calculator to check your Body Mass Index and health category instantly.",
						}),
					}}
				/>
			</Head>
						...
						<CardContent>
							<div className="prose max-w-none">
								...
								<ul className="list-disc list-inside space-y-1 text-gray-600">
									...
									<li>
										It doesn&apos;t account for age, gender, or muscle-to-fat ratio
									</li>
									<li>
										Consult healthcare professionals for comprehensive health assessment
									</li>
									<li>
										BMI is just one indicator of health, not a complete diagnosis
									</li>
								</ul>
							</div>
						</CardContent>
